...
<svg
	...
	style="enable-background:new 0 0 473.654 473.654; border: 7px solid transparent; border-radius: 50%"
	xml:space="preserve"
>
	<circle style="fill: white;" cx="236.827" cy="236.827" r="236.827" />
	<path
		style="fill:rgb(45,45,45);"
		d="M338.465,207.969c-43.487,0-86.975,0-130.459,0c11.08-11.08,22.161-22.161,33.241-33.245
